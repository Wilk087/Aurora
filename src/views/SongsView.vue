  ...
  <div class="songs-view p-6 h-full flex flex-col overflow-hidden">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-2">
        ...
        <SortDropdownMenu
          :options="sortOptions"
          :model-value="library.sortOrder"
          :label="`View: ${sortLabels[library.sortOrder]}`"
          :active-tags="activeTrackTags.length || undefined"
          ...
          <template #filter>
            ...
            <div class="px-3.5 py-1">
              <div class="flex items-center justify-between mb-1.5">
                ...
                <button v-if="activeTrackTags.length" @click="activeTrackTags = []" class="text-[10px] text-white/40 hover:text-white/70 transition-colors">Clear</button>
              </div>
...
function selectSort(order: string) {
  library.setSortOrder(order as SortOrder)
}
